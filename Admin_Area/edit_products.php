...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
        <lable for="product_category" class="form-lable">Product Category</lable>
...
?>
        ...
        <div class="d-flex">
            ...
            <img src="./product_images/<?php echo $product_image1?>" alt="" class="edie_image">
        </div>
        </div>
        ...
        <div class="d-flex">
            ...
            <img src="./product_images/<?php echo $product_image2?>" alt="" class="edie_image">
        </div>
        </div>
        ...
        <div class="d-flex">
            <input type="file" id="product_image1" name="product_image3" class="form-control w-90 m-auto" required="required">
            <img src="./product_images/<?php echo $product_image3?>" alt="" class="edie_image">
        </div>
        </div>
...
if(isset($_POST['edit_product'])){
    ...
    //checking for fiels empty or not
    ...
    or $product_image3 or $product_price==''){
        // echo "<script>alert('Please fill all the field and continue the process')</script>";
    }
    else{

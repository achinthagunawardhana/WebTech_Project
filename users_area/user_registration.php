...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-outline mb-4">
        ...
        <input type = "password" id= "user_password" class="form-control" placeholder ="Enter your passowrd" autocomplete="off" required="required" name="user_password"/>
    </div>
...
if($rows_count>0){
    echo "<script>alert('User_name or Email already exist')</script>";
}
